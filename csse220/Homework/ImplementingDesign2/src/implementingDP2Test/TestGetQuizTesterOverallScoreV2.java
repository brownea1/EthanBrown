...
public class TestGetQuizTesterOverallScoreV2 {	
	...
	private final static int AFTER_ADD_MORE_QUESTION_MAX = 100;
	...
	public static void oneTimeTearDown() {
		String className = TestGetQuizTesterOverallScoreV2.class.getSimpleName();
	...
	private static void simulatorSetupForAllTests() {
		...
		for (int questionID = 0; questionID < INITIAL_QUESTION_MAX; questionID++) {
		...
		// And finally add more questions with IDs: (INITIAL_QUESTION_MAX + 1)..(AFTER_ADD_MORE_QUESTION_MAX - 1)
	...
	public void testGetQuizTesterOverallScoreN01() {
		final double expectedAnswer = 0.41083333;
		simulatorSetupForAllTests();
	...
	public void testGetQuizTesterOverallScoreN02() {	
		final double expectedAnswer = 0.593333;	
		simulatorSetupForAllTests();
...
} // end class TestGetQuizTesterOverallScoreV2
