...
public class Interfaces {
	...
	public static void main(String[] args) {
		...
		myString = transformText(myString, new RepeatTransformer());
		myString = transformText(myString, new UppercaseTransformer());
		myString = transformText(myString, new RemoveLettersTransformer("F"));
	}
	 ...
	 * output = transform.transform(text); System.out.println(
	 * "Text after transform: " + output); return output; }
	 * 
	 */
